...
const products = [
  ...
  },
  {
    ...
    icon: <Award size={30} />,
    name: "صانع الشهادات",
    tagline: "6 قوالب احترافية · خطوط Google · توليد بالذكاء الاصطناعي",
    type: "قريباً",
    typeBadge: "soon",
    price: null,
    priceLabel: "قريباً",
    ...
    btnLabel: "قريباً",
    features: [
      "6 قوالب: كلاسيكي، ملكي، داكن وأكثر",
      "توليد تلقائي بالذكاء الاصطناعي",
      "توليد جماعي من Excel (حتى 500 شهادة)",
      "تصدير PNG وPDF",
      "روابط تحقق ذكية",
    ],
    available: false,
  ...
  {
    id: "compress",
    icon: <ImageDown size={30} />,
    name: "ضاغط الصور",
    tagline: "قلّل حجم صورك بدون فقدان ملحوظ في الجودة — JPEG · WebP · PNG",
    type: "مجاني",
    typeBadge: "free",
    price: null,
    priceLabel: "مجاني تماماً",
    ...
    btnLabel: "استخدم الآن",
    features: [
      "ضغط دفعات من الصور دفعة واحدة",
      "تحكم بالجودة من 10% إلى 100%",
  ...
  },
  {
    ...
    btnLabel: "استخدم الآن",
    features: [
      "دعم JPG · PNG · WEBP · HEIC",
      "ترتيب الصور بالسحب والإفلات",
      "حجم الصفحة: A4 · A3 · Letter",
      "وضع عمودي أو أفقي",
      "تصدير مباشر كـ PDF",
    ],
    available: true,
  },
  {
    ...
    btnLabel: "استخدم الآن",
    features: [
      "دمج PDF + صور في ملف واحد",
      "ترتيب الصفحات بالسحب والإفلات",
      "دعم JPG · PNG · WebP · PDF",
      "معاينة الصفحات قبل الدمج",
      "تحميل مباشر حتى 50 صفحة",
    ],
    available: true,
  },
  {
...
const badgeStyles: Record<string, string> = {
  ...
  soon: "bg-gray-500/10 text-gray-400 border-gray-500/20",
};
