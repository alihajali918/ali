...
const products = [
  ...
  },
  {
    ...
    name: "قالب التقارير",
    tagline: "أدخل بياناتك واطبع تقريراً احترافياً في دقيقة واحدة",
    type: "شراء مرة واحدة",
    typeBadge: "onetime",
    price: "49",
    priceLabel: "49 ريال",
    ...
    features: [
      ...
      "طباعة مباشرة أو PDF",
      "يدعم الشعار والمعلومات المخصصة",
    ],
    available: true,
  },
  {
    ...
    icon: <Award size={30} />,
    name: "صانع الشهادات",
    tagline: "منصة متكاملة لمراكز التدريب لإصدار شهادات احترافية",
    type: "اشتراك شهري",
    typeBadge: "subscription",
    price: "99",
    priceLabel: "99 ريال / شهر",
    color: "#F59E0B",
    href: "/tools/certs",
    btnLabel: "اشترك الآن",
    features: [
      "تصميم شهادات بالذكاء الاصطناعي",
      "تخصيص الألوان والشعار",
      "إصدار شهادات بالجملة",
      "رابط مشاركة + تحميل PDF",
    ],
    available: false,
  },
];
