...
import { UserPlus, Pencil, Trash2, Loader2, RotateCcw, Link2, ChevronDown, ChevronUp, Copy } from "lucide-react";
    ...
    <div dir="rtl">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-3">
          <button onClick={() => { const u = `${window.location.origin}/attend/${org}/scan`; navigator.clipboard.writeText(u); alert(`تم نسخ الرابط:\n${u}`); }}
